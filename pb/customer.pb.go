...
var file_customer_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x73, 0x32, 0x6e, 0x0a, 0x0f, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x53,
...
var file_customer_proto_depIdxs = []int32{
	...
	4, // 3: CustomerService.Create:input_type -> CustomerCreateRequest
	6, // 4: CustomerService.FindOne:input_type -> CustomerFindOneRequest
	0, // 5: CustomerService.Create:output_type -> Empty
	5, // 6: CustomerService.FindOne:output_type -> Customer
